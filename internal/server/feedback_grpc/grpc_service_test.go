...
func TestClientCreateFeedback(t *testing.T) {
	...
	respCreate, err := client.CreateFeedbackV1(ctx, reqCreate)
...
func TestClientCreateMultiFeedback(t *testing.T) {
	...
	respMultiCreate, err := client.CreateMultiFeedbackV1(ctx, reqMultiCreate)
	require.NoError(t, err)
...
func TestClientRemoveFeedback(t *testing.T) {
	...
	respRemove, err := client.RemoveFeedbackV1(ctx, reqRemove)
...
func TestClientDescribeFeedback(t *testing.T) {
	...
	respCreate, err1 := client.CreateFeedbackV1(ctx, reqCreate)
	...
	respDescribe, err := client.DescribeFeedbackV1(ctx, reqDescribe)
	require.NoError(t, err)
...
func TestClientListFeedbacks(t *testing.T) {
	...
	respMultiCreate, err := client.CreateMultiFeedbackV1(ctx, reqCreate)
	require.NoError(t, err)
	require.NotNil(t, respMultiCreate)
	...
	respList, err := client.ListFeedbacksV1(ctx, reqList)
	require.NoError(t, err)
...
func TestClientUpdateFeedback(t *testing.T) {
	...
	respUpdate, err := client.UpdateFeedbackV1(ctx, reqUpdate)
	require.NoError(t, err)
...
func startTestGrpcServer(t *testing.T,
	...
	service := feedback_grpc.New(feedbackRepo, prod, chunks)
