...
func (s *grpcServer) CreateProposalV1(
	ctx context.Context,
...
func (s *grpcServer) CreateMultiProposalV1(
	ctx context.Context,
...
func (s *grpcServer) RemoveProposalV1(
	ctx context.Context,
...
func (s *grpcServer) DescribeProposalV1(
	ctx context.Context,
...
func (s *grpcServer) ListProposalsV1(
	ctx context.Context,
