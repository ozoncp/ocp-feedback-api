...
// Source: github.com/ozoncp/ocp-feedback-api/internal/flusher (interfaces: Flusher)
...
func (m *MockFlusher) Flush(arg0 context.Context, arg1 []models.Entity) ([]models.Entity, error) {
	m.ctrl.T.Helper()
